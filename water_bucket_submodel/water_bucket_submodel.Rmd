...
In the current PLANT framework, plants are assumed to assimilate carbon at some rate $A_{max}$.

In the water competition model, assimilation rate, $A$, will be modelled as:

$$A = A_{max} * \beta$$,

where $B$ is a unitless soil moisture stress factor which is modelled as:
